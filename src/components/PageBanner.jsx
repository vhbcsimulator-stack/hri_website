...
// `paragraphs` holds any extra hero paragraphs an editor has added after the
// subtitle. Empty entries are skipped so a blank one never opens a gap.
export default function PageBanner({ eyebrow, title, subtitle, paragraphs = [], image, crumbs = [] }) {
  return (
    <Box
      sx={{
        position: 'relative',
